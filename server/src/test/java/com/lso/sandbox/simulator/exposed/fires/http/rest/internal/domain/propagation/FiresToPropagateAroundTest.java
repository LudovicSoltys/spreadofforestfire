...
import com.lso.sandbox.simulator.infra.facades.fire.query.OngoingFiresFactory;
...
class FiresToPropagateAroundTest {
    ...
    @ParameterizedTest
    @MethodSource("data")
    void should_return_some_result(String description, OneSingleBoard board, OngoingFires inputs, List<NextFire> expectedOutputs) {
    ...
    private static OneSingleBoard mockBoard(int w, int h) {
        OneSingleBoard mock = Mockito.mock(OneSingleBoard.class);
