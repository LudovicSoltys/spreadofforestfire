...
class CellRepositoryTest {
    ...
    void testUniqueConstraint() {
        ...
        // when
        ThrowableAssert.ThrowingCallable shouldRaiseError = () -> cells.save(new CellJpaEntity((byte) 2, (byte) 3));

        // then
        Assertions.assertThatThrownBy(shouldRaiseError).isInstanceOf(RuntimeException.class);
    }
}