 ...
 */
public interface FiresToPropagate extends Iterable<FireToPropagate> {
     ...
     */
    static FiresToPropagate of(AvailableBoard board, OngoingFires values) {
    ...
    class ImmutableFiresToPropagate implements FiresToPropagate {
         ...
         */
        ImmutableFiresToPropagate(AvailableBoard board, OngoingFires data) {
